...
/**
 * @Author 作者 : Panguaxe
 * @Description //TODO 				微信支付请求参数
 * @Date: 2019年07月12日 13:37
 * @Param  * @param null
 * @return
 **/
public class WeChatDefrayReqParams {

	/**
	 * 公众账号ID[必须]
	 */
	@XStreamAlias("appid")
	private String appId = WeChatPayConfig.WECHAT_MCH_APPID;
	...
	private String device_info = WeChatPayConfig.WECHAT_PAY_DEVICE_INFO;

	/**
	 * 随机字符串[必须]
	 */
	@XStreamAlias("nonce_str")
	private String nonce_str = ObjectUtils.getRandomStr(32);
